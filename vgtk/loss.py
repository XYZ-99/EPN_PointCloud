...
class MultiTaskDetectionLoss(torch.nn.Module):
    ...
    def forward(self, wts, label, y, gt_R, gt_T=None):
        ...
        """
        label[0]:  tensor([55, 54, 56, 58, 57, 59, 46, 45, 47, 49, 48, 50, 52, 51, 53, 40, 39, 41,
        43, 42, 44, 31, 30, 32, 34, 33, 35, 37, 36, 38, 22, 21, 23, 25, 24, 26,
        28, 27, 29, 16, 15, 17, 19, 18, 20,  7,  6,  8, 10,  9, 11, 13, 12, 14,
         1,  0,  2,  4,  3,  5], device='cuda:0')
         
        wts[0]:  tensor([[0.0165, 0.0169, 0.0167,  ..., 0.0165, 0.0167, 0.0165],
        [0.0164, 0.0164, 0.0161,  ..., 0.0165, 0.0161, 0.0161],
        [0.0176, 0.0175, 0.0173,  ..., 0.0172, 0.0172, 0.0172],
        ...,
        [0.0165, 0.0165, 0.0165,  ..., 0.0166, 0.0163, 0.0166],
        [0.0164, 0.0163, 0.0165,  ..., 0.0167, 0.0168, 0.0168],
        [0.0173, 0.0170, 0.0173,  ..., 0.0169, 0.0169, 0.0171]],
       device='cuda:0', grad_fn=<SelectBackward>)
       
        y.shape:  torch.Size([2, 4, 60, 60])
        y:  tensor([[[ 0.5187,  0.5072,  0.5233,  ...,  0.5134,  0.5553,  0.5483],
         ...,
         [ 0.5041,  0.4977,  0.5101,  ...,  0.5070,  0.5396,  0.5350]],

        [[ 0.1009,  0.1189,  0.1097,  ...,  0.1237,  0.1160,  0.1167],
         ...,
         [ 0.0917,  0.1102,  0.0999,  ...,  0.1240,  0.1014,  0.1037]],

        [[ 0.1022,  0.0840,  0.0970,  ...,  0.0848,  0.0872,  0.0950],
         ...,
         [ 0.1167,  0.1053,  0.1142,  ...,  0.1015,  0.1014,  0.1076]],

        [[-0.1518, -0.1492, -0.1511,  ..., -0.1447, -0.1578, -0.1587],
         ...,
         [-0.1658, -0.1605, -0.1635,  ..., -0.1569, -0.1589, -0.1636]]],
       device='cuda:0', grad_fn=<SelectBackward>)
        """
